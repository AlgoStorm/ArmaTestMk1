Below is the Route53 add-on for Bonus-B (Hosted Zone + ACM DNS validation records + app.jarvisStarkDEVOPS.com ALIAS → ALB).
...
############################################
# ALIAS record: app.jarvisStarkDEVOPS.com -> ALB
############################################

# Explanation: This is the holographic sign outside the cantina—app.jarvisStarkDEVOPS.com points to your ALB.
...
1) Confirm hosted zone exists (if managed)
  aws route53 list-hosted-zones-by-name \
    --dns-name jarvisStarkDEVOPS.com \
    --query "HostedZones[].Id"

2) Confirm app record exists
  aws route53 list-resource-record-sets \
  --hosted-zone-id <ZONE_ID> \
  --query "ResourceRecordSets[?Name=='app.jarvisStarkDEVOPS.com.']"
