Here, it is assumed that you have your own URL. I'm using jarvisStarkDEVOPS.com as an example


Alright — Lab 1C-Bonus-B (and yes, we’ll assume the students own jarvis-roar.com).
This turns your stack into a real enterprise pattern:
  Public ALB (internet-facing)
  Private EC2 targets (no public IP)
  TLS with ACM for jarvisStarkDEVOPS.com
  WAF attached to ALB
...
If you can submit this in Terraform, you’re no longer “a student who clicked around”— you’re a junior cloud engineer.
...
This assumes you already have from 1C / Bonus-A:
  aws_vpc.jarvis_vpc01
  aws_subnet.jarvis_public_subnets
  aws_subnet.jarvis_private_subnets
  aws_security_group.jarvis_ec2_sg01 (for private EC2)
  aws_instance.jarvis_ec201_private_bonus (private EC2 instance)
  aws_sns_topic.jarvis_sns_topic01 (SNS topic)

Add file: Bonus-B_outputs.tf

What you must implement (so you learn the right pain)
TLS (ACM) validation for app.jarvisStarkDEVOPS.com
...
Suggested student path (DNS):
  Create Route53 Hosted Zone for jarvis-roar.com
  Add aws_route53_record for ACM validation
  Add a CNAME (or ALIAS) pointing app.jarvis-roar.com → ALB DNS
...
7) Alarm created (ALB 5xx)
      ...
      aws cloudwatch describe-alarms \
        --alarm-name-prefix jarvis-alb-5xx

9) Dashboard exists
    
      aws cloudwatch list-dashboards \
        --dashboard-name-prefix jarvis
