variable "domain_name" {
  description = "Base domain students registered (e.g., jarvisStarkDEVOPS.com)."
  type        = string
  default     = "jarvisStarkDEVOPS.com"
}

variable "app_subdomain" {
  description = "App hostname prefix (e.g., app.jarvisStarkDEVOPS.com)."
  type        = string
  default     = "app"
}
