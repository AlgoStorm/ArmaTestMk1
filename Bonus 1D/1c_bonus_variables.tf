variable "domain_name" {
  description = "Base domain students registered (e.g., jarvistark@DEVOPS.com)."
  type        = string
  default     = "jarvistark@DEVOPS.com"
}

variable "app_subdomain" {
  description = "App hostname prefix (e.g., app.jarvistark@DEVOPS.com)."
  type        = string
  default     = "app"
}
