variable "aws_region" {
  description = "AWS Region for the jarvis lab environment."
  type        = string
  default     = "us-east-1"
}
...
variable "db_name" {
  ...
  type        = string
  default     = "mEGAd" # Students can change
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "Mega" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "jarvis@DEVOPS.com" # TODO: student supplies
}

variable "domain_name" {
  description = "Apex domain for CloudFront (e.g., jarvis-roar.com)."
  type        = string
  default     = "jarvis-roar.com"
}
