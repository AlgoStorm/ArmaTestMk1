...
################################################################################
# Lab 1b — Incident Report Generator
# 
# Use this to document incident response for grading
# Answer all questions. Be precise.
################################################################################
...
echo ""
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║ Lab 1b — INCIDENT REPORT                                      ║"
echo "║ Answer all questions. Be precise.                             ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo ""
echo "Complete the following sections:"
echo ""
echo "1. INCIDENT SUMMARY"
echo "   - What failed?"
echo "   - How was it detected?"
echo "   - Root cause (credential/network/database)"
echo "   - Time to recovery"
echo ""
echo "2. REMEDIATION"
echo "   - What action did you take?"
echo "   - Paste AWS CLI proof"
echo ""
echo "3. PREVENTIVE MEASURES"
echo "   - One improvement to speed recovery"
echo "   - One improvement to prevent recurrence"
echo ""
echo "4. REFLECTION QUESTIONS"
echo "   - Answer all 5 questions (A-E)"
echo ""
